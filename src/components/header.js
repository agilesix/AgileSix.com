  ...
  <header className="p-6 bg-white dark:bg-blue-dark">
    <div className={'max-w-6xl mx-auto flex items-center justify-between flex-wrap'}>
      ...
      <div className="block md:hidden">
        <button className="flex items-center px-3 py-2 border rounded text-blue-dark hover:text-white hover:border-white">
          <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
        </button>
      </div>
      <nav className="w-full block md:flex md:items-center md:w-auto">
        ...
        <div>
          <a href="#" className="inline-block px-4 py-3 leading-none border text-blue-dark border-blue-dark hover:border-transparent hover:text-white hover:bg-blue-dark mt-4 md:mt-0">Contact Us</a>
        </div>
      </nav>
    </div>
  </header>
